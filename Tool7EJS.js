...
app.get('/', function (req, res) {
  ...
  sql.connect(config, function (err) {
    ...
    sqlRequest.query(sqlQuery, function (err, data) {
      ...
      console.log(DataPlanSummaryEJS);
      //res.render(path.join(__dirname + '/public/html/Tool7.html'), { DataPlan: DataPlanSummaryEJS, q1: Q1SQLEJS,  q2: Q2SQLEJS, q3: Q3SQLEJS, q4: Q4SQLEJS,  q5: Q5SQLEJS,  q6: Q6SQLEJS,  q7: Q7SQLEJS, tool7table2: tool7table2EJS});
      res.render(path.join(__dirname + '/public/html/Tool7.html'), { DataPlan: DataPlanSummaryEJS, q1: Q1SQLEJS,  q2: Q2SQLEJS, q3: Q3SQLEJS, q4: Q4SQLEJS,  q5: Q5SQLEJS,  q6: Q6SQLEJS,  q7: Q7SQLEJS, tool7table1: tool7table1EJS, tool7table2: tool7table2EJS, tool7table3: tool7table3EJS});
      //res.end();
      sql.close();
    });
  });
    ...
    sql.connect(config, function (err) {
      ...
      sqlRequest.query(sqlQuery, function (err, data) {
        ...
        if (data) {
          ...
          let endHTML = '</textarea> <br> <div class="text-right"> <input type="submit" class="btn" value="Save" /> <!-- <div id="error"></div> --> </div> </form> </div> <br>';
    ...
    sql.connect(config, function (err) {
      ...
      sqlRequest.query(sqlQuery, function (err, data) {
        ...
        if (data) {
          ...
          //let endHTMLQ2 = '<th> <tr> <td> </td> </tr> </th> </tbody> </table> </div> <br> <!--Subquestions--> <div class="table-responsive"> <table id="subquestions" class="table center"> <thead class="thead-dark"> <tr class="text-center"> <th scope="col"> <div class="tool"> <label for="Title" class="align-middle"> Subquestions </label> </div> </th> <th scope="col"> <div class="tool"> <label for="Title" class="align-middle"> Evidence / Indicators </label> <span class="tooltiptext"> How will we know it? </span> </div> </th> <th scope="col"> <div class="tool"> <label for="Title" class="align-middle"> Method </label> <span class="tooltiptext"> How will we gather this information? <br> What tools shall we use? </span> </div> </th> <th scope="col"> <div class="tool"> <label for="Title" class="align-middle"> Start Date </label> <span class="tooltiptext"> When do we start collecting the data? </span> </div> </th> <th scope="col"> <div class="tool"> <label for="Title" class="align-middle"> End Date </label> <span class="tooltiptext"> When are we finished collecting the data? </span> </div> </th> <th scope="col"> <div class="tool"> <label for="Title" class="align-middle"> Responsibility </label> <span class="tooltiptext">Who will collect the data? </span> </div> </th> <th scope="col"> <div class="tool"> <label for="Title" class="align-middle"> Notes </label> <span class="tooltiptext">What should we keep in mind? </span> </div> </th> <th></th> </tr> </thead> <tbody> <tr> <th><input style="text-align: left;" type="text" class="form-control" id="QR" placeholder="Ex 1.1, 2.1, 3.1 ..." name="QR" value=""></th> <th><input style="text-align: left;" type="text" class="form-control" id="Indicator" placeholder="Indicator" name="Indicator"></th> <th><input style="text-align: left;" type="text" class="form-control" id="Method" placeholder="Method" name="Method"></th> <th><input style="text-align: left;" type="date" class="form-control" id="Start" placeholder="Start Date" name="Start"></th> <th><input style="text-align: left;" type="date" class="form-control" id="End" placeholder="end Date" name="End"></th> <th><input style="text-align: left;" type="text" class="form-control" id="Resp" placeholder="Responsible" name="Resp"></th> <th><input style="text-align: left;" type="text" class="form-control" id="Notes" placeholder="Notes" name="Notes"></th> <th></th> </tr> </table> <div> <input type="button" class="btn" value="Add Subquestion" onclick="addSubquestion()" /> <input type="submit" class="btn" value="Save" id="query" /> </div> </div> <br> <!--Data Sources gets autopopulated--> <div class="table-responsive"> <label for="Background" class="section">Data Sources</label> <!--<p>How will we gather this information? What tools shall we use?</p>--> <table id="dataCollTable" class="table center"> <thead class="thead-dark"> <tr class="text-center"> <th scope="col">Evaluation Question</th> <th scope="col">Data <br>Source 1</th> <th scope="col">Data<br>Source 2</th> <th scope="col">Data<br>Source 3</th> <th scope="col">Data<br>Source 4</th> <th scope="col">Data<br>Source 5</th> <th scope="col">Data<br>Source 6</th> <th></th> </tr> </thead> <tbody> <tr> <th><input style="text-align: left;" type="text" class="form-control" id="Num" placeholder="Ex 1.1, 2.1, 3.1" name="Num"></th> <th><input style="text-align: left;" type="text" class="form-control" id="S1" placeholder="Source 1" name="S1"></th> <th><input style="text-align: left;" type="text" class="form-control" id="S2" placeholder="Source 2" name="S2"></th> <th><input style="text-align: left;" type="text" class="form-control" id="S3" placeholder="Source 3" name="S3"></th> <th><input style="text-align: left;" type="text" class="form-control" id="S4" placeholder="Source 4" name="S4"></th> <th><input style="text-align: left;" type="text" class="form-control" id="S5" placeholder="Source 5" name="S5"></th> <th><input style="text-align: left;" type="text" class="form-control" id="S6" placeholder="Source 6" name="S6"></th> <th></th> </tr> </table> <input type="button" class="btn" value="Add Source" onclick="addSources();" /> <input type="submit" class="btn" value="Save" id="query" /> </div> <br> <!--Data Collection Methods autopopulated--> <div class="form-group"> <div class="form-group"> <label for="Background" class="section">Data Collection Methods</label> <p>Describe how you are collecting data. How many interviews will you conduct? How are evaluation participants recruited for different methods? How are your surveys administered? Where will focus groups be held?</p> <table id="dataMethTable" class="table center table-responsive"> <thead class="thead-dark"> <th class="text-left" style="width:20%" colspan="1" scope="col"> <label for="Title" class="align-middle">Data Method</label> </th> <th style="width:76%" colspan="1" scope="col"></th> <th style="width:4%" colspan="1" scope="col"></th> <th ></th> </thead> <tbody> <tr> <td><input style="text-align: left;" type="text" class="form-control" id="Meth" placeholder=" Type Meth" name="Method"> </td> <td><input style="text-align: left;" type="text" class="form-control" id="details" placeholder=" Type Details" name="details"> </td> <td></td> </tr> </tbody> </table> <input type="button" class="btn" value="Add Source" onclick="addMethod();" /> <input type="submit" class="btn" value="Save" id="query" /> </div> </div> </form> </div> <!--From template page--> <div class="container footer"> <hr> <!-- defines a thematic break in an HTML page --> <a href="https://www.evalacademy.com/" target="_blank"> <img alt="Logo" src="../img/Eval_Academy_logo.png" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp </a> <a href="https://www.threehive.ca/our-team" target="_blank"> <img alt=" Three Hive Consulting Logo" src="../img/Three Hive .png" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp </a> <a href="https://twitter.com/EvalAcademy" target="_blank" class="fa fa-twitter">&nbsp</a> <a href="https://www.linkedin.com/company/evalacademy" target="_blank" class="fa fa-linkedin">&nbsp</a> <a href="https://www.facebook.com/EvaluationAcademy" target="_blank" class="fa fa-facebook">&nbsp</a> <a href="https://www.evalacademy.com/faqs" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbspFAQs&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</a> <a href="https://www.evalacademy.com/contact" target="_blank">Contact Us</a> </div> </div></body></html>'
   ...
   */
    ...
    if (typeof QRHTML == 'object') {
      ...
      QRHTML.forEach(element => {
        let sqlQuery2 = " INSERT INTO Tool7Table (UserName, ProjectName, Subquestion, Indicator, Method, StartDate, EndDate, Responsible, Notes) VALUES ('" + userSession + "', '" + projectName + "', '" + QRHTML[i] + "','" + IndicatorHTML[i] + "','" + MethodHTML[i] + "','" + StartHTML[i] + "','" + EndHTML[i] + "','" + RespDueHTML[i] + "','" + NotesHTML[i] + " ');";
        //console.log(sqlQuery2);
        sqlRequest.query(sqlQuery2, function (err, data) {
          if (err) console.log(err)
          sql.close();
    ...
    // if table is only one row
      ...
      let sqlQuery2 = " INSERT INTO Tool7Table (UserName, ProjectName, Subquestion, Indicator, Method, StartDate, EndDate, Responsible, Notes) VALUES ('" + userSession + "', '" + projectName + "', '" + QRHTML + "','" + IndicatorHTML + "','" + MethodHTML + "','" + StartHTML + "','" + EndHTML + "','" + RespDueHTML + "','" + NotesHTML + " ');";
      //console.log(sqlQuery2);
      console.log(sqlQuery2);
      sqlRequest.query(sqlQuery2, function (err, data) {
        if (err) console.log(err)
    ...
    if (typeof NumHTML == 'object') {
      ...
      NumHTML.forEach(element => {
        let sqlQuery5 = " INSERT INTO Tool7Table2 (UserName, ProjectName, Subquestion, Source1, Source2, Source3, Source4, Source5, Source6) VALUES ('" + userSession + "', '" + projectName + "', '" + NumHTML[i] + "','" + S1HTML[i] + "','" + S2HTML[i] + "','" + S3HTML[i] + "','" + S4HTML[i] + "','" + S5HTML[i] + "','" + S6HTML[i] + " ');";
    ...
    // if table is only one row
      ...
      let sqlQuery5 = " INSERT INTO Tool7Table2 (UserName, ProjectName, Subquestion, Source1, Source2, Source3, Source4, Source5, Source6) VALUES ('" + userSession + "', '" + projectName + "', '" + NumHTML + "','" + S1HTML + "','" + S2HTML + "','" + S3HTML + "','" + S4HTML + "','" + S5HTML + "','" + S6HTML + " ');";
      //console.log(sqlQuery5);
      console.log(sqlQuery5);
      sqlRequest.query(sqlQuery5, function (err, data) {
        if (err) console.log(err)
    ...
    if (typeof MethodHTML2 == 'object') {
      ...
      MethodHTML2.forEach(element => {
        let sqlQuery8 = "INSERT INTO Tool7Table3 (UserName, ProjectName, Method, Details) VALUES ('" + userSession + "', '" + projectName + "', '" + MethodHTML2[i] + "','" + DetailsHTML[i] + " ');";
        sqlRequest.query(sqlQuery8, function (err, data) {
          console.log(data);
          if (err) console.log(err)
          sql.close();
    ...
    // if table is only one row
      ...
      let sqlQuery9 = "INSERT INTO Tool7Table3 (UserName, ProjectName, Method, Details) VALUES ('" + userSession + "', '" + projectName + "', '" + MethodHTML2 + "','" + DetailsHTML + " ');";
      sqlRequest.query(sqlQuery9, function (err, data) {
        console.log(data);
        if (err) console.log(err)
        sql.close();
